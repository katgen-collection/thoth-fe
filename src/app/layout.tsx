...
// Set data-theme before paint to avoid a light/dark flash on first load.
const themeScript = `
(function () {
  try {
    var ui = JSON.parse(localStorage.getItem("thothai-ui") || "{}");
    var theme = (ui.state && ui.state.theme) || "light";
